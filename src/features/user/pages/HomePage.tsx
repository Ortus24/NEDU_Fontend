      ...
      <header className="sticky top-0 z-50 w-full bg-white/80 dark:bg-background-dark/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-20 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/login"
              className="px-6 py-2.5 text-sm font-bold text-slate-600 dark:text-slate-300 hover:text-primary transition-colors"
            >
              Đăng nhập
            </Link>
            <button className="px-6 py-2.5 text-sm font-bold bg-primary text-white rounded-xl shadow-lg shadow-primary/20 hover:bg-primary/90 transition-all">
              Đăng ký
            </button>
          </div>
        </div>
      ...
      <footer className="bg-slate-900 text-slate-300 py-20">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 border-b border-slate-800 pb-16">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-sm leading-relaxed">
                Nền tảng kết nối gia sư hàng đầu Việt Nam, giúp mọi học sinh
                tiếp cận nền giáo dục cá nhân hóa chất lượng cao.
              </p>
            ...
            <div>
              <h4 className="text-white font-bold mb-6">Dành cho Học sinh</h4>
            ...
            <div>
              <h4 className="text-white font-bold mb-6">Dành cho Gia sư</h4>
              <ul className="flex flex-col gap-4 text-sm">
                <li>
                  <a className="hover:text-primary transition-colors" href="#">
                    Đăng ký làm Gia sư
            ...
            <div>
              ...
              <ul className="flex flex-col gap-4 text-sm">
                <li className="flex items-start gap-3">
                  ...
                  Tòa nhà NEDU, Quận 1, TP. Hồ Chí Minh
                </li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-xs text-slate-500">
            <p>© 2024 NEDU EdTech. All rights reserved.</p>
